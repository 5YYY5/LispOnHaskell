...
-- at runtime using the environment variable my_project_bindir.
...
-- environment variable my_project_libdir.
...
-- using the environment variable my_project_dynlibdir.
...
-- runtime using the environment variable my_project_datadir.
...
-- using the environment variable my_project_sysconfdir.
...
bindir     = "C:\\cabal\\bin"
libdir     = "C:\\cabal\\x86_64-windows-ghc-9.6.7\\my-project-0.1.0.0-inplace-my-project-test"
dynlibdir  = "C:\\cabal\\x86_64-windows-ghc-9.6.7"
datadir    = "C:\\cabal\\x86_64-windows-ghc-9.6.7\\my-project-0.1.0.0"
libexecdir = "C:\\cabal\\my-project-0.1.0.0-inplace-my-project-test\\x86_64-windows-ghc-9.6.7\\my-project-0.1.0.0"
